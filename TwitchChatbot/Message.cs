namespace TwitchChatbot
{
    public class Message
    {
        ...
        private bool _isConnectionSuccessfulMessage;
        private bool _isCrowdControlMessage;

        public string Content => _content;
        public string DisplayName => _displayName;
        public bool IsConnectionSuccessfulMessage => _isConnectionSuccessfulMessage;
        public bool IsCrowdControlMessage => _isCrowdControlMessage;

        public Message(bool isConnectionSuccessfulMessage)
        {
            _content = "";
            _displayName = "";
            _isConnectionSuccessfulMessage = isConnectionSuccessfulMessage;
        }
